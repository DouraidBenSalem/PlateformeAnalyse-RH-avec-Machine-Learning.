...
Application web Flask complète pour l'analyse RH avec quatre modules : Attrition, Formation, Segmentation et Dashboard Analytics.

## 📋 Fonctionnalités

### 🏠 Page d'Accueil
- Présentation des 4 modules disponibles
...
- 8 graphiques (pies, bars, histograms, box plots, violin plots, scatter plots)
- KPIs en temps réel (employés, attrition, rétention, segmentation)
...
│   └── indexseg.html                    # Formulaire segmentation
...
Accédez au dashboard via "Dashboard Analytics" pour voir les statistiques et graphiques interactifs.
...
- `GET /dashboard` - Dashboard analytics avec graphiques interactifs
